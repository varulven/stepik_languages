...
class TestAddToBasketButton:
    ...
    def test_find_button_add_to_basket(self, browser):
        ...
        assert button > 0, "Can't find this button :C"
    ...
    def test_button_add_to_basket_language(self, browser, language):
        ...
        if language == "fr":
            ...
            assert "some_expected_result" == button_name.text, f"You entered language {language}, but in settings only fr,es,ru,gb. Use languages from settins!"
